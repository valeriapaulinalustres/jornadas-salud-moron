...
const modeloIntegrado:Array<trabajos> = [
    ...
    {nombre: "Situación de infecciones y tratamientos antimicrobianos en pacientes internados en el Servicio de Clínica Médica del Hospital de Morón “Ostaciana B. de Lavignolle”", autor: "Iovanne, A.; Gauto, M.; Rojas Mena, M. P ; Rosas, A.; Mellini, M.; Goberna, L.; Santamaría, C.", link:"./assets/ppt/011.pptx"},
